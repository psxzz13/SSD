...
def main():
    ...
    # load train weights
    train_weights = "/home/yyj/Downloads/ssd300_attention/ssd300_attention/save_weights/ssd300-0.pth"
    model.load_state_dict(torch.load(train_weights, map_location='cpu')['model'])
    model.to(device)

    # read class_indict
    json_path = "./bdd100k_classes.json"
    ...
    # load image
    original_img = Image.open("./test4.jpg")
